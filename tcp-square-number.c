WRITE A TCP CLIENT-SERVER PROGRAM TO CALCULATE SQUARE OF A NUMBER
 CLIENT SIDE (tcp_client_square.c)
#include<stdio.h>
#include<sys/types.h>
...
int main()
{
 ...
 exit(0); }
 printf("Enter Any Number In Integer:\n");
 memset(buffer,'\0',MAX);
 r=read(0,buffer,MAX);
 if(r==-1)
 {
 ...
 SERVER SIDE (tcp_server_square.c)
#include<stdio.h>
#include<sys/types.h>
#include<sys/socket.h>
#include<sys/un.h>
